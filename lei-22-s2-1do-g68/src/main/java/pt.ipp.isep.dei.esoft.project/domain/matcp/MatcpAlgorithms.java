...
public class MatcpAlgorithms {
    ...
    private void numberOfBedrooms(){
        ...
        int numberOfBedrooms;
            for (int i = 0; i <orderRepository.getOrders().size() ; i++) {
                Apartment apartment= propertyRepository.getApartmentByAddress(orderRepository.getOrders().get(i).getAnnouncement().getProperty());
                if (apartment!=null){
                     numberOfBedrooms=apartment.getNumberOfRooms();
                } else {
                     numberOfBedrooms= propertyRepository.getHouseByAddress(orderRepository.getOrders().get(i).getAnnouncement().getProperty()).getNumberOfRooms();
                }
    ...
    private void numberOfBathroomsP(){
        numberOfBathrooms();
    }
    ...
    private void numberOfBathrooms(){
        ...
        for (int i = 0; i <orderRepository.getOrders().size() ; i++) {
            ...
            if (apartment!=null){
                ...
                numberOfBathrooms= propertyRepository.getHouseByAddress(orderRepository.getOrders().get(i).getAnnouncement().getProperty()).getNumberOfBathrooms();
            }
    ...
    private void numberOfGaragesP(){
        ...
        for (int i = 0; i <orderRepository.getOrders().size() ; i++) {
            ...
            if (apartment!=null){
                ...
                numberOfGarages= propertyRepository.getHouseByAddress(orderRepository.getOrders().get(i).getAnnouncement().getProperty()).getNumberOfGarages();
            }
